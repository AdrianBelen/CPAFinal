    ...
    <section class="content">
		<form action="#" method="post" class="contact-form" id="form1" runat="server">
		    <section class="columns">
                ...
                <h1>
                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:CPADataConnectionString %>" SelectCommand="SELECT Company FROM cpadata.company"> </asp:SqlDataSource> <!--Gets information about companies in the company table-->
                    <asp:SqlDataSource ID="SqlDataSource5" runat="server" ConnectionString="<%$ ConnectionStrings:CPADataConnectionString %>" SelectCommand="SELECT CompanyYear FROM cpadata.company"> </asp:SqlDataSource> <!--Gets year numbers from the y_ear table-->
                    Statements
                </h1>
                ...
                <p>
                    ...
                    <asp:DropDownList ID="DropdownList2" runat="server" AutoPostBack="True" DataSourceID="SqlDataSource5" DataTextField="CompanyYear" DataValueField="CompanyYear" Width="200px"></asp:DropDownList> <!--Lists years 2015-2019-->
                </p>
                ...
                <article> 
                    ...
                    <div>
                        <div>
                            ...
                            <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:CPADataConnectionString %>" SelectCommand="SELECT Company, CompanyYear, FinancialConstructs, Numbers FROM cpadata.incomestatement WHERE (Company = @Param1) AND (CompanyYear = @Param2)">
                                <SelectParameters>
                ...
                <article> 
                    ...
                    <div>
                        <div>
                            ...
                            <!--Connect table to data source -->
                            <asp:SqlDataSource ID="SqlDataSource4" runat="server" ConnectionString="<%$ ConnectionStrings:CPADataConnectionString %>" SelectCommand="SELECT Company, CompanyYear, FinancialConstructs, Numbers FROM cpadata.balancesheet WHERE (Company = @Param1) AND (CompanyYear = @Param2)">
                                <SelectParameters>                                   
                                    <asp:ControlParameter ControlID="DropdownList1" Name="Param1" PropertyName="SelectedValue" />
                                    <asp:ControlParameter ControlID="DropdownList2" Name="Param2" PropertyName="SelectedValue" />
                                </SelectParameters>
